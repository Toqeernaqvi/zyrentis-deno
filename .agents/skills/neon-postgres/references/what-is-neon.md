...
offer autoscaling, branching, instant restore, and scale-to-zero.

See the [official introduction](https://neon.com/docs/introduction.md) for
complete details.
...
1. **Serverless Architecture**: Compute scales automatically and can suspend
   when idle
...
- **Serverless applications**: Functions that need database access without
  managing connections
- **Development workflows**: Branch databases like code for isolated testing
- **Variable workloads**: Auto-scale during traffic spikes, scale to zero when
  idle
