...
The `neon-api` Python SDK is a Pythonic wrapper around the Neon REST API for
...
See the
[official Python SDK docs](https://neon.com/docs/reference/python-sdk.md) for
complete details.
...
All Neon accounts are organization-based. Discover the user's org first, then
pass `org_id` to project operations:
