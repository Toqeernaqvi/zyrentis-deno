...
The `@neondatabase/api-client` TypeScript SDK is a typed wrapper around the Neon
REST API for managing Neon resources programmatically.

For core concepts (Organization, Project, Branch, Endpoint, etc.), see
`what-is-neon.md`.

See the
[official TypeScript SDK docs](https://neon.com/docs/reference/typescript-sdk.md)
...
All Neon accounts are organization-based. You must discover the user's org
first, then pass `org_id` to project operations:
